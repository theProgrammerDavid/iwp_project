...
const basicAuthUsername = 'david';
const basicAuthPassword = 'ffJFhCcLjPq2Wm6';
//const adminUsername = 'ME_CONFIG_MONGODB_ADMINUSERNAME';
const adminUsername = 'david';
const adminPassword = 'ffJFhCcLjPq2Wm6';

//const adminPassword = 'ME_CONFIG_MONGODB_ADMINPASSWORD';
const dbAuthUsername = 'david';
const dbAuthPassword = 'ffJFhCcLjPq2Wm6';
...
module.exports = {
  ...
  basicAuth: {
    username: getFileEnv(basicAuthUsername) || 'david',
    password: getFileEnv(basicAuthPassword) || 'ffJFhCcLjPq2Wm6',
  },
